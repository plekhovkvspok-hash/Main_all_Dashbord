(function () {
  ...
  function renderRisks() {
    ...
    const notStarted = risks.filter((row) => ossNotStarted(row)).length;
    ...
    const summaryCards = [
      ...
      ['notStarted', notStarted, 'На старте'],
  ...
  function riskMatchesPanelFilter(row, filter) {
    ...
    if (filter === 'notStarted') return ossNotStarted(row);
