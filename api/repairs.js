...
const REPAIR_FACT_CSV_URL = 'https://docs.google.com/spreadsheets/d/1oSBAIW_FdH6So8dp-ygAYv5Ubs7OAaM1QSr1LiQQ9zA/export?format=csv&gid=2129505194';
const REPAIR_PLAN_SHEET_TITLE = '\u0422\u0420 \u041a\u0438\u0440\u043e\u0432_\u043f\u043b\u0430\u043d 26';
const REPAIR_BUDGET_SHEET_TITLE = '\u0411\u0430\u043b\u0430\u043d\u0441 \u0422\u0420 \u041a\u0438\u0440\u043e\u0432 2026';
const REPAIR_FACT_SHEET_TITLE = '\u0412\u0441\u0435 \u0440\u0430\u0431\u043e\u0442\u044b 2026';
...
export default async function handler(request, response) {
  ...
  try {
    ...
    response.status(200).json({
      ...
      factSheetTitle: REPAIR_FACT_SHEET_TITLE,
