...
module.exports = async function handler(request, response) {
  ...
  try {
    ...
    if (payload.kind === 'ballotsZip') {
      ...
      response.setHeader('Content-Disposition', 'attachment; filename="' + safeFileName('bulletins_OSS_' + (payload.house || payload.address || 'dom')) + '.zip"');
